...
var ClockWapper = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].div(_templateObject, __WEBPACK_IMPORTED_MODULE_2__constants_color__["a" /* default */].black, function (_ref) {
  var size = _ref.size;

  switch (size) {
    case 'small':
      return 'small' && css(_templateObject2);

    default:
      return 'default' && css(_templateObject3);
  }
});
...
//# sourceMappingURL=5.5cc689fb0d292d0c0a0e.hot-update.js.map