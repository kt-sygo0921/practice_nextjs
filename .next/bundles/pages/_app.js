...
var _jsxFileName = "/Users/kato-syogo/Desktop/git/Private/practice_nextjs/lib/with-redux-store.js";
...
/* harmony export (immutable) */ __webpack_exports__["h"] = takeEvery;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__("./node_modules/redux/es/redux.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducer__ = __webpack_require__("./reducers/reducer.js");


var combine = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["combineReducers"])({
  reducer: __WEBPACK_IMPORTED_MODULE_1__reducer__["a" /* reducer */]
});
...
var reducer = function reducer() {
  ...
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* actionTypes */].TICK:
      return Object.assign({}, state, {
        lastUpdate: action.ts,
        light: !!action.light
      });

    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* actionTypes */].INCREMENT:
      return Object.assign({}, state, {
        count: state.count + 1
      });

    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* actionTypes */].DECREMENT:
      return Object.assign({}, state, {
        count: state.count - 1
      });

    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* actionTypes */].RESET:
      return Object.assign({}, state, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants_actionTypes__ = __webpack_require__("./constants/actionTypes.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions_action__ = __webpack_require__("./actions/action.js");
...
__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(fetchUser),
    _marked2 =
/*#__PURE__*/
__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(requestSaga);
  ...
  return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function fetchUser$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Object(__WEBPACK_IMPORTED_MODULE_1_redux_saga_effects__["a" /* call */])(setInterval(function () {
            Object(__WEBPACK_IMPORTED_MODULE_1_redux_saga_effects__["b" /* put */])(Object(__WEBPACK_IMPORTED_MODULE_3__actions_action__["e" /* startClock */])());
          }, 1000));
...
function requestSaga() {
  return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function requestSaga$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Object(__WEBPACK_IMPORTED_MODULE_1_redux_saga_effects__["c" /* takeEvery */])(__WEBPACK_IMPORTED_MODULE_2__constants_actionTypes__["a" /* actionTypes */].TICK, fetchUser);
...
/* unused harmony default export */ var _unused_webpack_default_export = (requestSaga);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reducers_combine__ = __webpack_require__("./reducers/combine.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_redux_saga__ = __webpack_require__("./node_modules/redux-saga/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__saga__ = __webpack_require__("./saga.js");
...
function initializeStore() {
  ...
  var store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["createStore"])(__WEBPACK_IMPORTED_MODULE_2__reducers_combine__["a" /* default */]); // const store = createStore(combine, composeWithDevTools(applyMiddleware(sagaMiddleWare)))
